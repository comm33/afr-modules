...
<div class="btn-group thread-tools dropup">
							...
							<ul class="dropdown-menu dropdown-menu-dropup post-dropdown text-left pull-right">
								<div class="popover-arrow-dropup"></div>
								...
								<li class="divider"></li>
								<li><a href="#" class="delete_thread"><span class="text-danger"><i class="fa fa-fw fa-trash-o"></i> [[topic:thread_tools.delete]]</span></a></li>
								<!-- BEGIN thread_tools -->
								<li>
