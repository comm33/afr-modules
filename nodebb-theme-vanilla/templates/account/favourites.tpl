...
<div class="hero-container container m-t-lg clearfix">
	...
	<a href="{relative_path}/user/{userslug}/favourites" class="h3 text-lte block">Your favorite topics</a>
	</div>
	</header>
</div>
</div>
...
<section class="panel no-borders no-b-s">	
	...
	<div class="col-md-8 col-md-offset-2 m-t-lg">
		<ul class="user-favorites user-favourite-posts" data-nextstart="{nextStart}">

		
		<header class="text-label-header strong text-label-header text-muted text-left panel-heading no-borders">Favorites
		</header>
			...
			<div id="no-favourites-notice" class="panel animated fadeInDown text-center no-borders no-b-s {show_nofavourites}">
				<section class="text-center">
					<div class="panel-body nothing m-t no-borders text-muted">
						You currently do not have any favorites. You will need to favorite some posts to see them here!
					</div>
				</section>
			</div>
			<!-- ENDIF !posts.length -->
